...
<head>
  ...
  <style>
    ...
    .bg-3aa122 {
      background-color: rgba(58, 161, 34, 0.3);
    }
    .bg-3aa122-1 {
      background-color: rgba(58, 161, 34);
    }
    .text-3aa122 {
      color: rgba(58, 161, 34);
    }
  </style>
</head>
...
<body class="leading-normal tracking-normal" style="font-family: 'Montserrat', sans-serif">
  ...
  <nav class="flex items-center justify-between flex-wrap bg-3aa122 px-10">
    <div class="flex items-center flex-shrink-0 text-black mr-6">
      <img src="{{ asset('img/rs.png')}}" width="100" alt=""
        class="transform transition hover:scale-125 duration-300 ease-in-out" />
      <!-- <img src="{{ asset('img/logo.svg')}}"alt=""
        class="transform transition hover:scale-125 duration-300 ease-in-out" /> -->
      <span class="font-bold tracking-wider text-xl">
        &nbsp Komplain IT RSUD Daha Husada</span>
    </div>
    ...
    <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto text-center">
      <div class="text-md lg:flex-grow">
        <a href="/" class="block mt-4 lg:inline-block lg:mt-0 text-black mr-4 font-semibold">
          Home
        </a>
      ...
      <div>
        <button
          class="text-black font-semibold rounded-md py-3 border-black px-4 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
          <a href="{{ url('login')}}">Masuk</a>
        </button>
        <button
          class="text-3aa122 font-bold rounded-md py-3 px-4 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
  ...
  <!--Hero-->
  <div class="pt-5 px-16 bg-3aa122">
    <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
      ...
      <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left text-gray-800">
        ...
        <p class="leading-normal text-1xl mb-8">
          Sampaikan keluhan anda disini. Kami akan memprosesnya dengan cepat!
        </p>
        <button
          class="mx-auto lg:mx-0 bg-3aa122-1 text-white font-bold rounded-md my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
          <a href="{{ url('login')}}">Laporkan!</a>
        </button>
      </div>
      <!--Right Col-->
      <div class="w-full md:w-3/5 text-center">
        <img class="object-fill mx-36 transform transition"
      ...
      <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/4">
        ...
        <article class="overflow-hidden rounded-lg shadow-lg  text-gray-800">
          ...
          <header class="leading-tight p-2 md:p-4 text-center ">
            <h1 class="text-lg font-bold">1. Tulis Keluhan</h1>
  ...
  <!-- Footer -->
  <footer class="text-center font-medium bg-3aa122 py-5">
    © {{ now()->year }} Komplain RSUD Daha Husada | By
    <a class="text-black-500" target="_blank">Frankie Steinlie</a>
  </footer>
